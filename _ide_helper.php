 ...
 * Generated for Laravel 5.1.45 (LTS) on 2017-03-18.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \App\Modules\Kagi\Http\Models\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \App\Modules\Kagi\Http\Models\User 
         * @static 
         */
...
namespace Caffeinated\Plugins\Facades {
    ...
    class Plugin {
        ...
        {
            \Caffeinated\Plugins\Plugins::register($name, $callback);
        }
        ...
        {
            return \Caffeinated\Plugins\Plugins::exists($name);
        }
        ...
        {
            return \Caffeinated\Plugins\Plugins::call($name, $parameters);
        }
         ...
         * @static 
         */
        public static function group($name, $plugins)
        {
            \Caffeinated\Plugins\Plugins::group($name, $plugins);
        }
        ...
        {
            return \Caffeinated\Plugins\Plugins::groupExists($name);
        }
        ...
        {
            return \Caffeinated\Plugins\Plugins::callGroup($name, $parameters);
        }
...
namespace Caffeinated\Widgets\Facades {
    ...
    class Widget {
        ...
        {
            return \Caffeinated\Widgets\WidgetFactory::register($namespace);
        }
...
namespace AuraIsHere\LaravelMultiTenant\Facades {
    ...
    class TenantScopeFacade {
        ...
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::getTenants();
        }
         ...
         * @static 
         */
        public static function addTenant($tenantColumn, $tenantId)
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::addTenant($tenantColumn, $tenantId);
        }
         ...
         * @static 
         */
        public static function removeTenant($tenantColumn)
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::removeTenant($tenantColumn);
        }
         ...
         * @static 
         */
        public static function hasTenant($tenantColumn)
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::hasTenant($tenantColumn);
        }
        
        /**
         * Apply the scope to a given Eloquent query builder.
         *
         * @param \AuraIsHere\LaravelMultiTenant\Builder $builder
         * @param \AuraIsHere\LaravelMultiTenant\Model|\AuraIsHere\LaravelMultiTenant\Traits\TenantScopedModelTrait $model
         * @static 
         */
        public static function apply($builder, $model)
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::apply($builder, $model);
        }
        ...
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::creating($model);
        }
         ...
         * @static 
         */
        public static function getModelTenants($model)
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::getModelTenants($model);
        }
         ...
         * @static 
         */
        public static function getTenantId($tenantColumn)
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::getTenantId($tenantColumn);
        }
        ...
        public static function disable()
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::disable();
        }
        ...
        public static function enable()
        {
            return \AuraIsHere\LaravelMultiTenant\TenantScope::enable();
        }
         ...
         * @static 
         */
        public static function remove($builder, $model)
        {
            \AuraIsHere\LaravelMultiTenant\TenantScope::remove($builder, $model);
        }
...
namespace Caffeinated\SEO\Facades {
    ...
    class Metadata {
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::setTitle($title);
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::setDescription($description);
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::setKeywords($keywords);
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::setCanonical($url);
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::set($name, $content);
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::getTitle();
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::getDescription();
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::getKeywords();
        }
         ...
         * @static 
         */
        public static function getMiscellaneous()
        {
            return \Caffeinated\SEO\Handlers\Metadata::getMiscellaneous();
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::getCanonical();
        }
        ...
        {
            \Caffeinated\SEO\Handlers\Metadata::reset();
        }
        ...
        {
            return \Caffeinated\SEO\Handlers\Metadata::generate();
        }
...
namespace {
    ...
    class Plugin extends \Caffeinated\Plugins\Facades\Plugin {}
    
    class Theme extends \Caffeinated\Themes\Facades\Theme {}
    
    class Widget extends \Caffeinated\Widgets\Facades\Widget {}
    ...
    class TenantScope extends \AuraIsHere\LaravelMultiTenant\Facades\TenantScopeFacade {}
    
    class Meta extends \Caffeinated\SEO\Facades\Metadata {}
    
    class CMenu extends \Caffeinated\Menus\Facades\Menu {}
