...
@section('styles')
    <link href="{{ asset('assets/vendors/DataTables-1.10.7/plugins/integration/bootstrap/3/dataTables.bootstrap.css') }}"
          rel="stylesheet">
@stop
            ...
            <table id="table" class="table table-striped table-hover">
                ...
                @foreach ($menus as $menu)
                    <tr>
                        ...
                        <td>{{ $menu->title }}</td>
                        <td>
                            <a href="/admin/menus/{{ $menu->id }}/edit" class="btn btn-success"
                               title="{{ trans('kotoba::button.edit') }}">
                                <i class="fa fa-pencil fa-fw"></i>
                                {{ trans('kotoba::button.edit') }}
                            </a>
                            <a href="/admin/menulinks/{{ $menu->id }}" class="btn btn-info"
                               title="{{ trans('kotoba::button.new') }}">
